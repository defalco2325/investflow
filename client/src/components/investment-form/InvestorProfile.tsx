  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span>Yes</span>
                        {field.value && (
                          <span className="bg-[#D4A574] text-black text-xs font-semibold px-3 py-1 rounded">
                            REQUIRED
                          </span>
                        )}
                      </div>
        ...
        <Button 
          type="submit" 
          className="w-full bg-primary hover:opacity-90 text-primary-foreground font-semibold py-4 rounded-lg transition-all"
